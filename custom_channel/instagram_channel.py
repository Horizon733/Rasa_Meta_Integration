...
class Instagram:
    ...
    async def message(
        ...
        """Handle an incoming event from the instagram webhook."""
    ...
    async def _handle_user_message(
        ...
        out_channel = InstagramBot(self.client)
...
class InstagramBot(OutputChannel):
    """A bot that uses instagram-messenger to communicate."""
    ...
    def _convert_to_quick_reply(quick_replies: List[Dict[Text, Any]]) -> QuickReplies:
        """Convert quick reply dictionary to Instagram QuickReplies object"""

        instagram_quick_replies = []
        for quick_reply in quick_replies:
            try:
                instagram_quick_replies.append(
                    QuickReply(
        ...
        return QuickReplies(quick_replies=instagram_quick_replies)
...
class InstagramInput(InputChannel):
    ...
    def __init__(
        ...
        Args:
            ...
            messenger_access_token: access token to post in the name of the Instagram page
        """
    ...
    def blueprint(
        ...
        messenger_webhook = Blueprint("instagram", __name__)
        ...
        async def webhook(request: Request) -> HTTPResponse:
            ...
            messenger = Instagram(
                self.messenger_access_token, on_new_message
            )
